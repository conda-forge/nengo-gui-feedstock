...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nengo-gui-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15048&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nengo-gui-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nengo-gui` can be installed with:

```
conda install nengo-gui
```

It is possible to list all of the versions of `nengo-gui` available on your platform with:
